...
for spackver in "v0.19.2" "v0.20.2" ; do
    for baseimg in docker.io/ubuntu:22.04 ; do
        ...
        for rocmver in "5.6.1" "5.7" ; do
            ...
            echo_run podman build -f docker/Dockerfile_base_helper --format docker --build-arg BASEIMG=$rocm_baseimg --build-arg HIPCC_COMPILE_FLAGS_APPEND=$HIPCC_COMPILE_FLAGS_APPEND -t ${ROCM_BASE_TAG_NAME} .
